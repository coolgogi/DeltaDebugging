...
char *
r_complement(char * executeFile_path, char * input_file_path, int n, int * len, char * ans) {
	...
	for (int i = 0 ; i < n ; i ++) {
		...
		EXITCODE rt = r_runner(executeFile_path, complement, "output/ddmin_output.txt");
